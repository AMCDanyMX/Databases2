...
CHECK(SALARIO_MIN > 1200),
CHECK (SALARIO_MAX <20000)
);
...
ALTER TABLE EMPLEADOS_DAMC ADD CONSTRAINT EMPLEADO_GERENTE FOREIGN KEY (GERENTE_ID) REFERENCES EMPLEADOS_DAMC(EMPLEADO_ID);
...
--CREAMOS ALTER DE PIRMARY KEY DE HISTORIA_LABORAL_DAMC
ALTER TABLE HISTORIA_LABORAL_DAMC ADD CONSTRAINT EMPLEADO_ID_HL_FK PRIMARY KEY(EMPLEADO_ID);
--CREAMOS ALTER DE FOREIGN KEY DE EMPLEADOS_DAMC
