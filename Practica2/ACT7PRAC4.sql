...
CUSTOMER_ID NUMBER(4) CONSTRAINT CUSTOMER_ID_NN NOT NULL,
CUSTOMER_NAME VARCHAR2(25),
CUSTOMER_FIRST_LAST_NAME VARCHAR2(25),
CUSTOMER_SECOND_LAST_NAME VARCHAR2(25),
CUSTOMER_ADDRESS VARCHAR2(50),
CUSTOMER_EMAIL VARCHAR2(50),
CUSTOMER_PHONE_NUMBER VARCHAR2(10) CONSTRAINT C_P_N_UNIQUE UNIQUE
);
...
ACCOUNT_NUMBER VARCHAR2(25) CONSTRAINT ACCOUNT_N_NN NOT NULL
);
...
--INDEX ----------------------------------------------------------------------------------------------------------------------------
CREATE INDEX CUST_INDX ON CUSTOMER(CUSTOMER_NAME);
CREATE INDEX CUST_AP_INDX ON CUSTOMER(CUSTOMER_FIRST_LAST_NAME, CUSTOMER_SECOND_LAST_NAME);

CREATE INDEX BRANCH_INDX ON BRANCH(BRANCH_NAME);

CREATE INDEX EMP_INDX ON EMPLOYEE(EMPLOYEE_NAME);

--SEQUENCE
CREATE SEQUENCE SEQUENCE_CUST_ID
    INCREMENT BY 1
    START WITH 1;
...
CREATE SEQUENCE SEQUENCE_LOAN_ID
    INCREMENT BY 1
    START WITH 1;
    
CREATE SEQUENCE SEQUENCE_CTYPECUST_ID
    INCREMENT BY 1
    START WITH 1;
...
CREATE SYNONYM L_B FOR LOAN_BRANCH;
CREATE SYNONYM LOA FOR LOAN;
CREATE SYNONYM C_B FOR CUST_BANKER;
CREATE SYNONYM EMPL FOR EMPLOYEE;
CREATE SYNONYM DEP FOR DEPOSITOR;
CREATE SYNONYM BORR FOR BORROWER;
CREATE SYNONYM L_P FOR LOAN_PAYMENT;
CREATE SYNONYM PAYM FOR PAYMENT;
CREATE SYNONYM AC_B FOR ACCOUNT_BRANCH;
CREATE SYNONYM ACCT FOR ACCOUNT;
CREATE SYNONYM S_A FOR SAVINGS_ACCOUNT;
CREATE SYNONYM CH_A FOR CHECKING_ACCOUNT;
