CREATE TABLE ESTABLISHMENT(
    ...
    CONSTRAINT ESTABLISHMENT_ID_PK PRIMARY KEY(ESTABLISHMENT_ID)
);
...
CREATE TABLE STORED(
    ...
    CONSTRAINT PRODUCT_ID_STORED FOREIGN KEY(PRODUCT_ID) REFERENCES PRODUCT(PRODUCT_ID),
